...
class SaleResumeView extends StatelessWidget {
  final List<SelectedProductResume> selectedProducts;

  const SaleResumeView({super.key, required this.selectedProducts});
